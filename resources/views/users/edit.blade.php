...
@endif
<form action="{{route('users.update', $user->id)}}" method="post" data-toggle="validator">
    {{ method_field('patch')}}	  
    {{ csrf_field() }}
	...
	<hr />	  
        <div class="row">	    
    		...
    		<div class="form-group col-md-4">
    			...
    			<input type="date" class="form-control" name="birthDate" value="{{$user->birthDate or old('birthDate')}}" required>
    		</div>	  
    	</div>	  	  
    	<div class="row">	    
        ...
        <div class="row">       
            ...
            <div class="form-group col-md-6">         
                ...
                <input type="text" class="form-control" name="registration" value="{{$user->registration or old('registration')}}" required>
            </div>              
        </div>
        <div class="row">       
            <div class="form-group col-md-6">         
        ...
        <div class="row">       
            <div class="form-group col-md-6">         
                ...
                <input type="password" data-minlength="6" class="form-control" id="password" name="password" value="{{$user->password or old('password')}}" required>
                <div class="help-block">Minimo de 6 caracteres</div>
            </div>              
            <div class="form-group col-md-6">         
                <label for="password_confirmation">Confirmar Senha</label>         
                <input type="password" class="form-control" name="password_confirmation" value="{{$user->password or old('password')}}" data-match="#password" data-match-error="As senhas não coincidem!" required>
